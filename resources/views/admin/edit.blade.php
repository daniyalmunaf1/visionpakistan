							...
							<div class="menu menu-column menu-rounded menu-sub-indention menu-active-bg fw-semibold my-auto" id="#kt_aside_menu" data-kt-menu="true">
								...
								<div data-kt-menu-trigger="click" class="menu-item menu-accordion">
									...
									<div class="menu-sub menu-sub-accordion">
										...
										<div class="menu-item">
											<!--begin:Menu link-->
											<a class="menu-link" href="documentation/base/utilities.html" title="Check out over 200 in-house components" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right">
												<span class="menu-bullet">
													<span class="bullet bullet-dot"></span>
												</span>
					...
					<div id="kt_header" class="header">
						...
						<div class="container d-flex flex-stack flex-wrap gap-2" id="kt_header_container">
							...
							<div class="page-title d-flex flex-column align-items-start justify-content-center flex-wrap me-lg-2 pb-5 pb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', lg: '#kt_header_container'}">
								<!--begin::Heading-->
								<h1 class="d-flex flex-column text-dark fw-bold my-0 fs-1">Edit User {{$user->name}}</h1>
								<hr>
								<!--end::Heading-->
							</div>
							<!--end::Page title=-->
						...
						<div class="w-lg-500px p-10">
                            ...
                            @csrf
                                ...
                                <div class="fv-row mb-8">
									<!--begin::Name-->
                                    <input id="name" placeholder="Name" value="{{$user->name}}" class="form-control bg-transparent" type="text" name="name" required autofocus />
									<!--end::Name-->
								</div>
								<div class="fv-row mb-8">
									<!--begin::Email-->
                                    <input id="email" placeholder="Email" value="{{ $user->email }}" class="form-control bg-transparent" type="email" name="email" required autofocus readonly/>
									<!--end::Email-->
								</div>
								<div class="fv-row mb-8">
									<!--begin::Name-->
                                    <input id="number" placeholder="Phone Number" value="{{$user->number}}" class="form-control bg-transparent" type="text" name="number" required autofocus />
									<!--end::Name-->
								</div>						
								<div class="menu-content px-3">
								@foreach($roles as $role)
									<label class="form-check form-switch form-check-custom form-check-solid">
										...
										<span class="form-check-label  fs-7">{{$role->name}}</span>
									</label>
									<br>
								@endforeach
								</div>		
