...
<html lang="en">
  ...
  <meta name="author" content="Vision Pakistan">
    ...
    <title>Vision Pakistan - TeamBonus Requests</title>
  ...
  .phone-num {
   ...
   @if (Session::has('message'))
        ...
        <div class="row d-flex justify-content-center">
                        ...
                        <h1>Silver Bonus Requests</h1>
                          ...
                          <tbody>
                              ...
                              <tr>
                                  ...
                                  <td>
                                     <a type="submit" href="{{ route('bonusdone',[$Request->id,$Request->user_id,'silver']) }}" class="btn-primary btn">Done</a> 
                                   </td>
                              </tr>
                              @endforeach
            ...
            <div >
                      <h1 style="margin-top:50px;">Gold Bonus Requests</h1>
                      <table class="table table-striped">
                          <!--Table head-->
                          <thead>
                              <tr>
                          ...
                          <tbody>
                              ...
                              <tr>
                                  ...
                                  <td>{{$Request->accountname}}</td>
                                  <td>
                                  <a type="submit" href="{{ route('bonusdone',[$Request->id,$Request->user_id,'gold']) }}" class="btn-primary btn">Done</a> 
                                   </td>
                              </tr>
                              @endforeach
